...
export class ContiguousTokensStore {
	private _lineTokens: (Uint32Array | ArrayBufferLike | null)[];
	private _len: number;
	...
	public getTokens(topLevelLanguageId: string, lineIndex: number, lineText: string): LineTokens {
		let rawLineTokens: Uint32Array | ArrayBufferLike | null = null;
	...
	private static _massageTokens(topLevelLanguageId: LanguageId, lineTextLength: number, _tokens: Uint32Array | ArrayBufferLike | null): Uint32Array | ArrayBufferLike {
	...
	private _insertLines(insertIndex: number, insertCount: number): void {
		...
		const lineTokens: (Uint32Array | ArrayBufferLike | null)[] = [];
	...
	public setTokens(topLevelLanguageId: string, lineIndex: number, lineTextLength: number, _tokens: Uint32Array | ArrayBufferLike | null, checkEquality: boolean): boolean {
	...
	private static _equals(_a: Uint32Array | ArrayBufferLike | null, _b: Uint32Array | ArrayBufferLike | null) {
		if (!_a || !_b) {
			return !_a && !_b;
		}
	...
	private _acceptDeleteRange(range: IRange): void {
		...
		let lastLineTokens: Uint32Array | ArrayBufferLike | null = null;
